...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fom.pathhelper' => 'getFom_PathhelperService',
            ...
            'geo.converter' => 'getGeo_ConverterService',
            ...
            'owsproxy.terminatelistener' => 'getOwsproxy_TerminatelistenerService',
    ...
    /**
     * Gets the 'app_layerset' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Element\Type\LayersetAdminType A Mapbender\CoreBundle\Element\Type\LayersetAdminType instance
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\DataSourceBundle\Component\DataStoreService A Mapbender\DataSourceBundle\Component\DataStoreService instance
     */
    protected function getData_SourceService()
    {
        return $this->services['data.source'] = new \Mapbender\DataSourceBundle\Component\DataStoreService($this);
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.terminate', array(0 => 'owsproxy.terminatelistener', 1 => 'onTerminate'), 0);
        $instance->addListenerService('owsproxy.terminate', array(0 => 'owsproxy.logginglistener', 1 => 'onTerminate'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'dbgeo', 'path' => NULL, 'user' => 'root', 'password' => NULL, 'persistent' => true, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Entity'), 2 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Entity'), 3 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Entity'), 4 => ($this->targetDirs[3].'/owsproxy/src/OwsProxy3/CoreBundle/Entity'), 5 => ($this->targetDirs[3].'/vendor/mapbender/digitizer/Entity'), 6 => ($this->targetDirs[3].'/vendor/mapbender/data-source/Entity')));
        ...
        $d->setEntityNamespaces(array('FOMUserBundle' => 'FOM\\UserBundle\\Entity', 'MapbenderCoreBundle' => 'Mapbender\\CoreBundle\\Entity', 'MapbenderWmcBundle' => 'Mapbender\\WmcBundle\\Entity', 'MapbenderWmsBundle' => 'Mapbender\\WmsBundle\\Entity', 'OwsProxy3CoreBundle' => 'OwsProxy3\\CoreBundle\\Entity', 'MapbenderDigitizerBundle' => 'Mapbender\\DigitizerBundle\\Entity', 'MapbenderDataSourceBundle' => 'Mapbender\\DataSourceBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3072bfe23b20ad9e1bfa946f74d8ad57c3af020adcad35bc1a89ef33e0de4851');
    ...
    /**
     * Gets the 'features' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\DataSourceBundle\Component\FeatureTypeService A Mapbender\DataSourceBundle\Component\FeatureTypeService instance
     */
    protected function getFeaturesService()
    {
        return $this->services['features'] = new \Mapbender\DataSourceBundle\Component\FeatureTypeService($this);
    }
    ...
    /**
     * Gets the 'fom.acl.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\Component\AclManager A FOM\UserBundle\Component\AclManager instance
     */
    ...
    /**
     * Gets the 'fom.identities.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\Component\FOMIdentitiesProvider A FOM\UserBundle\Component\FOMIdentitiesProvider instance
     */
    protected function getFom_Identities_ProviderService()
    {
        $this->services['fom.identities.provider'] = $instance = new \FOM\UserBundle\Component\FOMIdentitiesProvider();
    ...
    /**
     * Gets the 'fom.pathhelper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\CoreBundle\Component\PathHelper A FOM\CoreBundle\Component\PathHelper instance
     */
    protected function getFom_PathhelperService()
    {
        return $this->services['fom.pathhelper'] = new \FOM\CoreBundle\Component\PathHelper($this);
    }

    /**
     * Gets the 'fom.security.failed_login_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\EventListener\FailedLoginListener A FOM\UserBundle\EventListener\FailedLoginListener instance
     */
    protected function getFom_Security_FailedLoginListenerService()
    {
        return $this->services['fom.security.failed_login_listener'] = new \FOM\UserBundle\EventListener\FailedLoginListener($this);
    }

    /**
     * Gets the 'fom.security.user_profile_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\EventListener\UserProfileListener A FOM\UserBundle\EventListener\UserProfileListener instance
     */
    ...
    /**
     * Gets the 'fom.user.subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\EventListener\UserSubscriber A FOM\UserBundle\EventListener\UserSubscriber instance
     */
    ...
    /**
     * Gets the 'fom_groups' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\CoreBundle\Form\Type\FOMGroupsType A FOM\CoreBundle\Form\Type\FOMGroupsType instance
     */
    protected function getFomGroupsService()
    {
        return $this->services['fom_groups'] = new \FOM\CoreBundle\Form\Type\FOMGroupsType($this);
    }

    /**
     * Gets the 'fom_roles' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\Component\RolesService A FOM\UserBundle\Component\RolesService instance
     */
    ...
    /**
     * Gets the 'form.fom.ace' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\Form\Type\ACEType A FOM\UserBundle\Form\Type\ACEType instance
     */
    protected function getForm_Fom_AceService()
    {
        return $this->services['form.fom.ace'] = new \FOM\UserBundle\Form\Type\ACEType($this->get('security.context'), $this->get('security.acl.provider'), $this);
    }

    /**
     * Gets the 'form.fom.acl' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\Form\Type\ACLType A FOM\UserBundle\Form\Type\ACLType instance
     */
    protected function getForm_Fom_AclService()
    {
        return $this->services['form.fom.acl'] = new \FOM\UserBundle\Form\Type\ACLType($this->get('security.context'), $this->get('security.acl.provider'), $this->get('router'));
    }
    ...
    /**
     * Gets the 'geo.converter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\CoreBundle\Component\GeoConverterComponent A FOM\CoreBundle\Component\GeoConverterComponent instance
     */
    protected function getGeo_ConverterService()
    {
        return $this->services['geo.converter'] = new \FOM\CoreBundle\Component\GeoConverterComponent($this);
    }
    ...
    /**
     * Gets the 'layerset_instances' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Element\Type\LayersetInstancesAdminType A Mapbender\CoreBundle\Element\Type\LayersetInstancesAdminType instance
     */
    ...
    /**
     * Gets the 'mapbender' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Mapbender A Mapbender\CoreBundle\Mapbender instance
     */
    ...
    /**
     * Gets the 'mapbender.assetic.filter.sass' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Eslider\Filter\ScssFilter A Eslider\Filter\ScssFilter instance
     */
    ...
    /**
     * Gets the 'mapbender.twig.element_class' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Extension\ElementExtension A Mapbender\CoreBundle\Extension\ElementExtension instance
     */
    protected function getMapbender_Twig_ElementClassService()
    {
        return $this->services['mapbender.twig.element_class'] = new \Mapbender\CoreBundle\Extension\ElementExtension();
    }

    /**
     * Gets the 'mapbender.validator.css' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Validator\Constraints\ScssValidator A Mapbender\CoreBundle\Validator\Constraints\ScssValidator instance
     */
    ...
    /**
     * Gets the 'owsproxy.logginglistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OwsProxy3\CoreBundle\EventListener\LoggingListener A OwsProxy3\CoreBundle\EventListener\LoggingListener instance
     */
    protected function getOwsproxy_LogginglistenerService()
    {
        return $this->services['owsproxy.logginglistener'] = new \OwsProxy3\CoreBundle\EventListener\LoggingListener($this);
    }

    /**
     * Gets the 'owsproxy.terminatelistener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OwsProxy3\CoreBundle\EventListener\TerminateListener A OwsProxy3\CoreBundle\EventListener\TerminateListener instance
     */
    protected function getOwsproxy_TerminatelistenerService()
    {
        return $this->services['owsproxy.terminatelistener'] = new \OwsProxy3\CoreBundle\EventListener\TerminateListener($this);
    }
    ...
    /**
     * Gets the 'security.access.rootaccount.voter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOM\UserBundle\Security\Authorization\Voter\RootAccountVoter A FOM\UserBundle\Security\Authorization\Voter\RootAccountVoter instance
     */
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Component\SecurityContext A Mapbender\CoreBundle\Component\SecurityContext instance
     */
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/user/logout'));
        ...
        $l->setOptions(array('login_path' => '/user/login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'secured_area', $l, $m, array('check_path' => '/user/login/check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '599b1d08192520.74818418', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $i, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, '/user/login', false), NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'signer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Component\Signer A Mapbender\CoreBundle\Component\Signer instance
     */
    ...
    /**
     * Gets the 'target_element' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mapbender\CoreBundle\Element\Type\TargetElementType A Mapbender\CoreBundle\Element\Type\TargetElementType instance
     */
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ar.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.az.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.bg.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ca.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.cs.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.da.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/fom/src/FOM/CoreBundle/Resources/translations/messages.de.xlf'), 4 => ($this->targetDirs[3].'/fom/src/FOM/ManagerBundle/Resources/translations/messages.de.xlf'), 5 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Resources/translations/messages.de.xlf'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.de.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.de.yml'), 8 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.de.yml'), 9 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.de.yml'), 10 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.de.yml'), 11 => ($this->targetDirs[3].'/owsproxy/src/OwsProxy3/CoreBundle/Resources/translations/messages.de.xlf'), 12 => ($this->targetDirs[3].'/vendor/mapbender/digitizer/Resources/translations/messages.de.yml'), 13 => ($this->targetDirs[3].'/vendor/mapbender/data-source/Resources/translations/messages.de.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.el.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/fom/src/FOM/CoreBundle/Resources/translations/messages.en.xlf'), 4 => ($this->targetDirs[3].'/fom/src/FOM/ManagerBundle/Resources/translations/messages.en.xlf'), 5 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Resources/translations/messages.en.xlf'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.en.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.en.yml'), 8 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.en.yml'), 9 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.en.yml'), 10 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.en.yml'), 11 => ($this->targetDirs[3].'/owsproxy/src/OwsProxy3/CoreBundle/Resources/translations/messages.en.xlf'), 12 => ($this->targetDirs[3].'/vendor/mapbender/digitizer/Resources/translations/messages.en.yml'), 13 => ($this->targetDirs[3].'/vendor/mapbender/data-source/Resources/translations/messages.en.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/fom/src/FOM/CoreBundle/Resources/translations/messages.es.xlf'), 4 => ($this->targetDirs[3].'/fom/src/FOM/ManagerBundle/Resources/translations/messages.es.xlf'), 5 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Resources/translations/messages.es.xlf'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.es.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.es.yml'), 8 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.es.yml'), 9 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.es.yml'), 10 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.es.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fa.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.fr.yml'), 4 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.fr.yml'), 5 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.fr.yml'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.fr.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.fr.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.gl.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.he.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hr.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.hu.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.id.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.it.yml'), 4 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.it.yml'), 5 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.it.yml'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.it.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.it.yml')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ja.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lb.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lt.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.lv.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/fom/src/FOM/CoreBundle/Resources/translations/messages.nl.xlf'), 4 => ($this->targetDirs[3].'/fom/src/FOM/ManagerBundle/Resources/translations/messages.nl.xlf'), 5 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Resources/translations/messages.nl.xlf'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.nl.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.nl.yml'), 8 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.nl.yml'), 9 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.nl.yml'), 10 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.nl.yml')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.no.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pl.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/fom/src/FOM/CoreBundle/Resources/translations/messages.pt.xlf'), 3 => ($this->targetDirs[3].'/fom/src/FOM/ManagerBundle/Resources/translations/messages.pt.xlf'), 4 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Resources/translations/messages.pt.xlf'), 5 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.pt.yml'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.pt.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.pt.yml'), 8 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.pt.yml'), 9 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.pt.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_BR.xlf')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ro.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/fom/src/FOM/CoreBundle/Resources/translations/messages.ru.xlf'), 4 => ($this->targetDirs[3].'/fom/src/FOM/ManagerBundle/Resources/translations/messages.ru.xlf'), 5 => ($this->targetDirs[3].'/fom/src/FOM/UserBundle/Resources/translations/messages.ru.xlf'), 6 => ($this->targetDirs[3].'/mapbender/src/Mapbender/CoreBundle/Resources/translations/messages.ru.yml'), 7 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmcBundle/Resources/translations/messages.ru.yml'), 8 => ($this->targetDirs[3].'/mapbender/src/Mapbender/WmsBundle/Resources/translations/messages.ru.yml'), 9 => ($this->targetDirs[3].'/mapbender/src/Mapbender/ManagerBundle/Resources/translations/messages.ru.yml'), 10 => ($this->targetDirs[3].'/mapbender/src/Mapbender/PrintBundle/Resources/translations/messages.ru.yml'), 11 => ($this->targetDirs[3].'/owsproxy/src/OwsProxy3/CoreBundle/Resources/translations/messages.ru.xlf'), 12 => ($this->targetDirs[3].'/vendor/mapbender/digitizer/Resources/translations/messages.ru.yml'), 13 => ($this->targetDirs[3].'/vendor/mapbender/data-source/Resources/translations/messages.ru.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sk.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sl.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Cyrl.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sr_Latn.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.sv.xlf')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.th.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.tr.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.vi.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.zh_CN.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Resources/translations/security.ua.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'FOMCoreBundle:Form:fields.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'FOMCoreBundle:Form:fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'AsseticBundle', 6 => 'DoctrineBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'FOSJsRoutingBundle', 9 => 'FOMCoreBundle', 10 => 'FOMManagerBundle', 11 => 'FOMUserBundle', 12 => 'MapbenderCoreBundle', 13 => 'MapbenderWmcBundle', 14 => 'MapbenderWmsBundle', 15 => 'MapbenderManagerBundle', 16 => 'MapbenderPrintBundle', 17 => 'MapbenderMobileBundle', 18 => 'OwsProxy3CoreBundle', 19 => 'DoctrineFixturesBundle', 20 => 'MapbenderDigitizerBundle', 21 => 'MapbenderDataSourceBundle', 22 => 'WebProfilerBundle', 23 => 'SensioDistributionBundle', 24 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addGlobal('fom', array('server_name' => 'Mapbender3', 'server_version' => '3.0.6.3', 'server_logo' => 'bundles/mapbendercore/image/logo_mb3.png'));
    ...
    /**
     * Gets the 'twig.extension.stringloader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'twig.form.resources' => array(
                ...
                1 => 'FOMCoreBundle:Form:fields.html.twig',
            ),
            ...
            'fom.pathhelper.class' => 'FOM\\CoreBundle\\Component\\PathHelper',
            ...
            'mapbender.static_assets' => true,
            'mapbender.sass_assets' => false,
            'mapbender.static_assets_cache_path' => ($this->targetDirs[2].'/../web/assets'),
            'mapbender.cache_creation' => '2017-08-21T12:48:56-05:00',
            0 => '3.0.2',
                            ...
                            'mapbender_users' => array(
                                ...
                                'layers' => array(
                                    10 => array(
                                        ...
                                        'title' => 'User',
                                        'visible' => true,
                                        'legendurl' => 'http://wms.wheregroup.com/cgi-bin/mapbender_user.xml?version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=Mapbender_User&format=image/png&STYLE=default',
                                    ),
                                    22 => array(
...
',
            ...
            'wmsloader.example_url' => 'http://wms.wheregroup.com/cgi-bin/mapbender_user.xml?VERSION=1.1.1&REQUEST=GetCapabilities&SERVICE=WMS',
            ...
            'owsproxy.terminatelistener.class' => 'OwsProxy3\\CoreBundle\\EventListener\\TerminateListener',
